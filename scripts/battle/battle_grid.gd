...
func _ready():
	for color in STONE_TYPES:
		...
		row_bonus_textures[color] = create_colored_texture(line_bonus, COLOR_CODES[STONE_TYPES.find(color)])
		col_bonus_textures[color] = create_colored_texture(line_bonus, COLOR_CODES[STONE_TYPES.find(color)], true)
		double_line_textures[color] = create_colored_texture(double_line, COLOR_CODES[STONE_TYPES.find(color)])
...
func get_texture_by_bonus(cell_type: String, bonus_type: BONUS_TYPES):
	match bonus_type:
		...
		BONUS_TYPES.DOUBLE: return double_line_textures[cell_type]
